...
async def test_create_vehicle_happy_path(service):
    input = CreateVehicleInput(
        manufacturer="Toyota", model_name="Camry", vehicle_class=VehicleClass.midsize,
        year=2024, body_type=BodyType.sedan, transmission=Transmission.automatic, fuel_type=FuelType.gasoline,
    )
