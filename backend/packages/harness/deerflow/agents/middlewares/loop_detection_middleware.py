...
_DEFAULT_WINDOW_SIZE = 40  # track last N tool calls
_DEFAULT_MAX_TRACKED_THREADS = 200  # LRU eviction limit (covers 160+ concurrent agents)
_DEFAULT_TOOL_FREQ_WARN = 70  # warn after 70 calls to the same tool type
_DEFAULT_TOOL_FREQ_HARD_LIMIT = 100  # force-stop after 100 calls to the same tool type
